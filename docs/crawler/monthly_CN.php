...
//当前受支持的小米机型代号；
$smnd = array("capricorn", "natrium", "tiffany", "meri", "sagit", "wayne", "dipper", "sirius", "platina", "ursa", "equuleus", "cepheus","crux", "grus", "pyxis", "vela", "laurus", "lotus", "oxygen", "nitrogen", "scorpio", "jason", "cappu", "clover", "lithium", "chiron", "polaris", "perseus");
//当前受支持的红米机型代号；
$srmd = array("santoni", "rosy", "riva", "vince", "cereus", "cactus", "sakura", "onclite", "pine","olive","olivelite", "mido", "whyred", "ugglite", "ugg", "lavender", "violet","ginkgo", "begonia", "davinci", "raphael", "raphaels");
