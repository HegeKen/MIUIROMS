...
//当前受支持的小米机型代号；
$smnd = array("sagit", "wayne", "dipper", "sirius", "platina", "ursa", "equuleus", "cepheus","crux", "grus", "pyxis", "vela", "tucana", "laurus", "umi", "cmi", "vangogh", "nitrogen", "jason","chiron", "polaris", "perseus");
//当前受支持的红米机型代号；
$srmd = array("onclite", "pine","olive","olivelite","olivewood","whyred","lavender", "violet","ginkgo", "begonia", "merlin", "curtana", "joyeuse", "excalibur", "davinci", "raphael", "raphaels","phoenix", "picasso", "lmi",);
function fastbootROM($device)
{
    $deviceName = array(
		...
		"phoenix" => "Redmi K30 4G版",
		"picasso" => "Redmi K30 5G版",
		"lmi" => "Redmi K30 Pro",
        //"" => "",
    ...
    $device = $device;
    $url = "http://update.miui.com/updates/v1/fullromdownload.php?d=" . $device . "&b=F&r=cn&n=chinatelecom";
    ...
    if ($match[0] == null) {
        ...
        echo $deviceName[$device] . "&nbsp;线刷包（电信定制机版）: " . $match[0][0] . "</br>";
    }
}

echo " </br>";
echo "<title>当前最新稳定版</title>";
echo "小米机型: </br>";
