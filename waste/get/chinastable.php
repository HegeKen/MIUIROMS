...
//当前受支持的小米机型代号；
$smnd = array("dipper", "sirius", "platina", "ursa", "equuleus", "cepheus","crux", "grus", "pyxis", "vela", "tucana", "laurus", "umi", "cmi", "vangogh","cas","venus","polaris", "perseus");
//当前受支持的红米机型代号；
$srmd = array("onclite", "pine","olive","olivelite","olivewood","lancelot","dandelion","merlin","atom","bomb","lavender", "violet","ginkgo", "begonia","lime", "cannon", "gauguin", "davinci", "raphael", "raphaels","phoenix", "picasso","picasso_48m", "lmi","cezanne","apollo");
