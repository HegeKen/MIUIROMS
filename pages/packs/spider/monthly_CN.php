...
//当前受支持的小米机型代号；
$smnd = array("dipper", "sirius", "platina", "ursa", "equuleus", "cepheus","crux", "grus", "pyxis", "vela", "laurus", "tucana", "umi","cmi","cas","vangogh","lotus", "polaris", "perseus");
//当前受支持的红米机型代号；
$srmd = array("onclite", "pine","olive","olivelite", "lancelot","dandelion","merlin","atom","bomb","lavender", "violet","ginkgo", "begonia", "davinci", "raphael", "phoenix","picasso","picasso_48m","lmi","cezanne","apollo");
