...
//当前受支持的小米机型代号；
$smnd = array("cepheus", "grus", "pyxis", "vela", "laurus", "lotus", "oxygen", "nitrogen", "scorpio", "jason", "cappu", "clover", "lithium", "chiron", "polaris", "perseus");
//当前受支持的红米机型代号；
$srmd = array("lavender", "violet", "raphael", "begonia");
function weeklyROM($device)
{
    $week_version = "21.6.9";
    $deviceName = array(
        //小米数字系列
    ...
    $device = $device;
    $url = "https://xiaomifirmwareupdater.com/miui/" . $device ."/weekly/21.6.9/";
    //$url = "https://update.miui.com/updates/v1/fullromdownload.php?d=" . $device . "&b=X&r=cn&n=";
    $referer = "https://www.miui.com/shuaji-393.html";
...
//http://update.miui.com/updates/v1/fullromdownload.php?d=cancro_lte_ct&b=F&r=cn&n=
echo " </br>";
echo "<title>MIUI 第474周更新列表</title>";
